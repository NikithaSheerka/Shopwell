...
def detect(debug, img_path):
    ...
    # img_path='/home/saicharan/Pictures/Recall@10.jpg'
    ...
    for text_dict in text_location_list:
        if text_dict['string_type'] == 2:
            for text_dict_test in text_location_list:
                print("text_dict_test  : ", text_dict_test)
...
# main function to test different fPunctions independently
def main():
    ap = argparse.ArgumentParser()
    # img1 = '/home/saicharan/SJSU Courses/272 Enterprise Software Platforms/FoodLabelAnalysis/FoodLabelAnalysis/ml/images/labels_2_cropped.jpg'
    # img1 = '/home/saicharan/Downloads/result/test.jpg'
    # img1 = '/home/saicharan/SJSU Courses/272 Enterprise Software Platforms/FoodLabelAnalysis/testImages/0819poptartlabel.jpg'
    # img1 = "/home/saicharan/Pictures/testImages/FDA-whatsnewLabel.png" 
    # img1 = "/home/saicharan/Pictures/testImages/AfNutritonOnCarton-400x400.jpg"
    img1 = "/home/saicharan/Pictures/testImages/test3_failed.jpg"
