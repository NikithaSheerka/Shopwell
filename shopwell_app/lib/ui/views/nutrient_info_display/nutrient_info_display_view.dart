...
class NutrientInfoDisplayView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // print(nutrients[].isDanger == true);
    var healthyItemsCount = 0;
    var unhealthyItemsCount = 0;
    var totalItems = 0;
    for (var nutrient in nutrients) {
      totalItems += 1;
      if (nutrient.isDanger != null) {
        if (nutrient.isDanger == true) {
          unhealthyItemsCount += 1;
        } else {
          healthyItemsCount += 1;
        }
      }
      ...
      staticChild: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // ignore: avoid_print
            (unhealthyItemsCount != null && unhealthyItemsCount > 0)
                ? Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.circle, color: Colors.red, size: 20),
                      Text(
                        " $unhealthyItemsCount / $totalItems Bad",
                        style: TextStyle(
                            color: Colors.red,
                            fontSize: 20,
            ...
            return Column(
              children: [
                DProgressBar(
                  ...
                  isDanger: (e.isDanger != null) ? e.isDanger : null,
                  descr: e.descr ?? "",
                ),
                xsHeightSpan,
              ],
